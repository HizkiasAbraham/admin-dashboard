...
export function DatePicker(props: DatePickerInput) {
  ...
  return (
    <div className={`relative ${width || ""}`}>
      <select onChange={(e) => onDatePicked(e.target.value)} className="bg-none display-none background-none border border-inactive rounded-xl px-4 py-2 pl-4 pr-4 w-full cursor-pointer">
